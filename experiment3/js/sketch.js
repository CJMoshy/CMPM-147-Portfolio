...
$(document).ready(() => {
  ...
  const s1 = (sketch) => {
    ...
    sketch.setup = () => {
      ...
      const reseedButton = document.getElementById('reseedButton1')
  ...
  const s2 = (sketch) => {
    ...
    sketch.setup = () => {
      const canvas2 = sketch.createCanvas(canvasContainer2.width(), canvasContainer2.height())
      canvas2.parent('canvas-container2')
      const reseedButton = document.getElementById('reseedButton2')
      reseedButton.addEventListener('click', () => {
        reseed(sketch)
      })
